...
const GyandeepHero = () => {
  return <section className="min-h-screen bg-gradient-hero relative overflow-hidden" style={{
    marginTop: '0px'
  }}>
      {/* Decorative Elements */}
            ...
            <div className="card-3d bg-white rounded-3xl shadow-hero animate-fade-in">
              ...
              <div className="card-3d-content p-3 sm:p-4 md:p-6 lg:p-8 xl:p-12">
                ...
                <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
                  ...
                  <Button variant="outline" size="lg" className="bg-primary text-primary-foreground border-0 px-4 md:px-6 lg:px-8 py-3 md:py-4 lg:py-6 text-sm md:text-base lg:text-lg rounded-2xl shadow-button hover:shadow-glow">
                    Our Story
                  </Button>
                </div>
          ...
          <div className="relative animate-fade-in animate-delay-200 order-1 md:order-2 -mt-2 sm:-mt-4">
            <div className="relative hero-anim-border">
              <div className="blob-card">
                ...
                <img src="/lovable-uploads/759d8b35-7caa-44ea-a405-bbd7d9d07a26.png" alt="Gyandeep Public School Campus" className="w-full h-full object-cover rounded-lg relative z-10" />
              </div>
              {/* Contact Info Card */}
