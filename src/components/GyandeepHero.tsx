        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-hero animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-gradient-hero text-primary-foreground px-8 py-6 text-lg rounded-2xl shadow-golden hover:shadow-glow">About Our School
            ...
            <div className="grid grid-cols-3 gap-6 mt-12 pt-8 border-t border-gray-100">
              ...
              <div className="text-center">
                ...
                <div className="text-2xl font-bold text-purple-force" style={{color: 'hsl(280 100% 60)'}}>98%</div>
