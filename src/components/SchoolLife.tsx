    ...
    <section id="school-life" className="py-16 sm:py-20 md:py-24 bg-gradient-subtle">
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8 mb-16 sm:mb-20">
            {dailyActivities.map((activity, index) => {
              const Icon = activity.icon;
              return (
                <Card key={index} className="glass-card border-none interactive-card group animate-on-scroll anim-border-flow" style={{animationDelay: `${index * 0.1}s`}}>
