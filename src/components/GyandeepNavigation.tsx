          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <span>Helpline: 0542-2612080, 7309433152, 9839173720</span>
              </div>
            </div>
            <div className="flex items-center space-x-4">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gradient">Gyandeep Public School</h1>
                <p className="text-sm text-muted-foreground">Dharsauna, Cholapur, Varanasi-221101</p>
                <p className="text-xs text-muted-foreground">Affiliated to CBSE (10+2) New Delhi | School Code: 71458</p>
              </div>
            </div>
